...
ApplicationWindow {
    ...
    height: 720
    visible: true
    title: qsTr("Разметка вакансий и обучение модели")
        ...
        Column {
            ...
            ListView {
                ...
                model: ListModel {
                    ...
                    ListElement { title: "Датасет"; source: "qrc:/pages/DatasetPage.qml"; image: "qrc:/icons/database.svg";}
                    ListElement { title: "Обучение"; source: "qrc:/pages/TrainPage.qml"; image: "qrc:/icons/book.svg";}
                    ListElement { title: "Обновление"; source: "qrc:/pages/RefreshPage.qml"; image: "qrc:/icons/refresh-cw.svg";}
                }
            }
        }
    }
